package com.mk27manoj.crewtools.calendar;
...
import com.mk27manoj.crewtools.calendar.add_task.LocationDialogPicker;
...
public class ViewTaskActivity extends AppCompatActivity implements DatePickerFragment.DatePickerListener,
    ...
    private String TASK_OBJECT_ID = "task_object_id";
    private ParseObject[] mParseObjects;
...
//                                    task.setEmployees(mCVEmployeesJSONArray);
            ...
            // No Parse Object
            Toast.makeText(ViewTaskActivity.this, "Nothing is set for the Task", Toast.LENGTH_SHORT).show();
        }
    }
}
