...
public class PaidFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentView = inflater.inflate(R.layout.fragment_paid, container, false);
        initViews();
        setListeners();
        return parentView;
    }
    ...
    private void initViews() {
        ...
        mListView = (ListView) parentView.findViewById(R.id.listView_paid_invoices);

        ParseQuery.getQuery(CVInvoice.class)
                .whereNotEqualTo("paid", null)
                .findInBackground(new FindCallback<CVInvoice>() {
                    @Override
                    public void done(List<CVInvoice> objects, ParseException e) {
                        if (e == null){
                            if (mListView != null) {
                                mListView.setAdapter(new InvoiceAdapter(mContext, objects, 4));
                            }
                        }
