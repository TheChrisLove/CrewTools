 ...
 */
public class PriorityPickerActivity extends AppCompatActivity {
    ...
    private void initViews() {
        mContext = PriorityPickerActivity.this;
    ...
    private void addView() {
        ...
        baseView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CrewToolsConstants.RESPONSE_PRIORITY_NUMBER, count);
                intent.putExtra(CrewToolsConstants.RESPONCE_MESSAGE, priorities.get(count));
                setResult(CrewToolsConstants.REQUEST_CREATE_JOB_PICK_PRIORITY, intent);
